...
namespace WordSearchSolver.Domain.Entities;
...
public sealed class WordSearch
{
    ...
    private WordSearch(Dimensions dimensions, char[,] letters, IReadOnlyList<string> words)
    {
    ...
    /// </summary>
    public static WordSearch Parse(string fileContent)
    {
        ...
        return new WordSearch(dimensions, letters, words);
    }
